...
public class AccountInMemoryTest {
    ...
    public void setUp() throws Exception {
        ...
        accounts = new AccountInMemory(new MarketHttpClient());
        accounts.addUser(TEST_USER_ID);
        accounts.addMoney(TEST_USER_ID, TEST_USER_INITIAL_MONEY);
    }
    ...
    public void buyStocks() {
        assertThat(accounts.buyStocks(TEST_USER_ID, TEST_COMPANY_NAME, 10).toBlocking().single())
                .isEqualTo("SUCCESS");
    }

    @Test
    public void sellStocks() {
        assertThat(accounts.sellStocks(TEST_USER_ID, TEST_COMPANY_NAME, 10).toBlocking().single())
                .isEqualTo("SUCCESS");
    }

    @Test
    public void testNotExistingCompany() {
        assertThat(accounts.buyStocks(TEST_USER_ID, "aaa", 10).toBlocking().single())
                .isEqualTo("Company with name 'aaa' doesn't exists");
    }

    @Test
    public void testNotEnoughStocks() {
        assertThat(accounts.buyStocks(TEST_USER_ID, TEST_COMPANY_NAME, 2000).toBlocking().single())
                .isEqualTo("Not enough stocks in market");
    }

    @Test
    public void testNotEnoughMoney() {
        assertThat(accounts.buyStocks(TEST_USER_ID, TEST_COMPANY_NAME, 150).toBlocking().single())
